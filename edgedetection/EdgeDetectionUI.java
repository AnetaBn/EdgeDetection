...
public class EdgeDetectionUI {
    ...
    private JPanel fillNorthPanel() {
        ...
        /**
         * Metoda obsługujące pole wpisania progu dolnego algorytmu Canny'ego
         */
        ...
        /**
         * Metoda obsługujące pole wpisania progu górnego algorytmu Canny'ego
         */
        ...
        /**
         * Metoda implementuje ActionListener dla przycisku wyboru filtru
         */
        ...
        /**
         * Metoda implementuje ActionListener dla przycisku wyboru obrazka
         * @exception IOException W przypadku błędu wczytania panelu
         */
        ...
        /**
         * Metoda implementuje ActionListener dla przyciesku detekcji
         * @exception IOException W przypadku błędu detekcji krawędzi
         */
        ...
        detect.addActionListener(event -> {
            try {
                ...
                if ((lowerThresholdValue < 0 ) && (filterChoice.getSelectedItem().equals(CANNY_EDGE_DETECTION))) {
                    lowerThresholdValue = edgeDetection.LOWER_THRESHOLD;
                ...
                if ((higherThresholdValue < 0) && (filterChoice.getSelectedItem().equals(CANNY_EDGE_DETECTION))) {
                    higherThresholdValue = edgeDetection.HIGHER_THRESHOLD;
